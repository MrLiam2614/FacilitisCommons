...
public class BabyZombieVillagerNitwit implements CompleteMob {
    @Override
    public Entity spawnMob(Positions positions) {
        ...
        mob.setVillagerProfession(Villager.Profession.NITWIT);
        mob.setBaby();
        mob.setVillagerType(Villager.Type.SNOW);
