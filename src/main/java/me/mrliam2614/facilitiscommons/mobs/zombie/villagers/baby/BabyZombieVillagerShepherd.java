...
public class BabyZombieVillagerShepherd implements CompleteMob {
    @Override
    public Entity spawnMob(Positions positions) {
        ...
        mob.setVillagerProfession(Villager.Profession.SHEPHERD);
        mob.setBaby();
        mob.setVillagerType(Villager.Type.DESERT);
